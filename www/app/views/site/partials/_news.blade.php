  ...
  <div class="row">
    ...
    <div class="col-md-6 m-t-lg">
      <section class="rss">
        ...
        <div class="rss-body">
          <div class="rss-container-content">
            <div class="title"><a href="#">DOD eyes specialized program to enlist undocumented immigrants</a></div>
          ...
          <hr/>
          <div class="rss-container-content">
            <div class="title"><a href="#">US to send 6,000 to Jordan for annual military exercise</a></div>
            <div class="desc">The VA loan used to buy and finance a property is the best program around for those who qualify and need or want a no money...<a href="#">Read more</a></div>
            <div class="by">1:22 PM, May 20, 2014</div>
          </div>
          <hr/>
          <div class="rss-container-content">
            <div class="title"><a href="#">Ukraine's hobbled navy: 'Times are not the best'</a></div>
