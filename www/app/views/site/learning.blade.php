@section('content')
	<div class="row m-b-lg">
		<div class="col-md-9">
			...
			<div class="desc">
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sem mauris, eleifend in consectetur id, ornare vitae turpis. Pellentesque viverra gravida velit, eu vulputate risus scelerisque id.
			</div>
		</div>
		<div class="col-md-3 text-right social-container">
			<a href="https://www.facebook.com/valoancaptain" target="_blank"><span class="facebook m-r-sm"></span></a>
			<a href="https://twitter.com/valoancaptain" target="_blank"><span class="twitter m-r-sm"></span></a>
			<a href="https://plus.google.com/106646976175468640852/posts" target="_blank"><span class="googleplus m-r-sm"></span></a>
		</div>
	</div>
	<div class="content">
		<div class="row m-t-lg m-b-lg">
			...
			<div id="scroll-able" class="col-md-9">
				...
				<section class="rss m-b-lg" data-section="6" id="section6">
					<div class="rss-header">How do I get started?</div>
					<div class="rss-body">
						<div class="rss-container-content">
							<div class="m-t-lg desc">
								Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.<br/></br>
